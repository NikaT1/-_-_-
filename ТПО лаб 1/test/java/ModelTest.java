...
import tpo.task_3.disease.DiseaseResult;
import tpo.task_3.disease.ProcessOfDisease;
import tpo.task_3.disease.TypeOfDisease;
import tpo.task_3.lang.*;
...
public class ModelTest {
    ...
    class EntityClassTest {
        ...
        @Test
        @DisplayName("Check creation null parents")
        void testAddingNullParentsToHuman() {
            assertThrows(IllegalArgumentException.class, () -> h1.addParent(null));
        }
        @Test
        @DisplayName("Check creation null children")
        void testAddingNullChildrenToHuman() {
            assertThrows(IllegalArgumentException.class, () -> h1.addChildren(null));
        }
    }
}
